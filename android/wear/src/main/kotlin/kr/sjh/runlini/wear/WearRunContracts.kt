...
data class WearRunState(
    ...
    val ghostStartConfirmed: Boolean = false,
    val ghostStartCandidateCount: Int = 0,
    val ghostStartLastEvaluatedPointCount: Int = 0,
    val ghostTrackedDistanceAlongRouteM: Double? = null,
