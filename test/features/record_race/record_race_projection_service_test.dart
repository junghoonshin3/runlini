...
import 'package:runlini/features/record_race/service/record_race_projection_service.dart';
import 'package:runlini/features/record_race/types/record_race_projection_frame.dart';
import 'package:runlini/features/run_tracking/types/run_point.dart';
import 'package:runlini/features/run_tracking/types/run_session.dart';

void main() {
  group('TimeBasedRecordRaceProjectionService', () {
    const service = TimeBasedRecordRaceProjectionService();
    ...
    test('marks runner ahead when runner timestamp is later', () {
      ...
      final frame = service.project(
        ...
        recordRaceSession: session,
        elapsedMs: 6000,
      );

      expect(frame.relativeState, RecordRaceRelativeState.ahead);
    ...
    test('marks runner behind when runner timestamp is earlier', () {
      ...
      expect(frame.relativeState, RecordRaceRelativeState.behind);
    });
  });
}
