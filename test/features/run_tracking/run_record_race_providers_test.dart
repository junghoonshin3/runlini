...
Future<void> _confirmRecordRaceStart({
...
void main() {
  test(
    'active recordRace run shows the current recordRace marker on the map',
    () async {
      ...
      final recordRaceSession = _recordRaceSession();
      ...
      final frameSubscription = container.listen<RecordRaceFrame?>(
      ...
      expect(
        visibleMapViewState.recordRaceMarkerPoint,
        frame.recordRaceMarkerPoint,
      );
    },
  );
}
