...
class LiveRunMetricsPanel extends StatelessWidget {
  const LiveRunMetricsPanel({super.key, required this.metrics, this.ghostRace});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _PrimaryMetric(
            label: '거리',
            value: formatLiveRunDistance(metrics.distanceKm),
            ...
            children: [
              Expanded(
                child: _SecondaryMetric(
                  label: '평균 페이스',
                  value: formatLiveRunAveragePace(metrics.averagePaceSecPerKm),
              ...
              Expanded(
                child: _SecondaryMetric(
                  label: '평균 스피드',
                  value: formatLiveRunAverageSpeed(metrics.averageSpeedKmh),
