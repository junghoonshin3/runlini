...
class RunDetailLineChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final yBounds = _ChartBounds.from(min: min, max: max);
    ...
    return Container(
      key: Key('detail-chart-${title.toLowerCase()}'),
          ...
          SizedBox(
            ...
            child: LineChart(
              LineChartData(
                ...
                lineTouchData: _touchData(valueFormatter),
                lineBarsData: [
                  LineChartBarData(
                    spots: spots,
                    color: color,
  ...
  LineTouchData _touchData(String Function(double value) valueFormatter) {
...
class _EmptyChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      key: Key('detail-chart-empty-${title.toLowerCase()}'),
...
class _ChartBounds {
  ...
  factory _ChartBounds.from({required double min, required double max}) {
